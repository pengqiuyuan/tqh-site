		...
		<footer>
			<div class="row" >
				<div style="background:url(${ctx}/static/images/assets/example/footer.png);background-size:cover;height:160px;">
					<p class="friend_link">友情链接： <a href="http://www.appchina.com" target="_blank">应用汇| </a><a href="http://app.mi.com" target="_blank">小米应用商店 | </a><a href="http://apk.hiapk.com" target="_blank">安卓市场 | </a><a href="http://www.fzhuake.com" target="_blank">华科信息 </a></p>
